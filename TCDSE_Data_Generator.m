...
writetable(table_final,"layer_building_xyCoord.xlsx")
writetable(household_data,'layer_household.xlsx');
writetable(individual_data,'layer_individual.xlsx');
...
shapewrite(table_buildings, extractBefore(luf_name,".")+"_building_footprints"+".shp")
copyfile(strcat(path_luf,extractBefore(luf_name,".")+".prj"), extractBefore(luf_name,".")+"_building_footprints"+".prj", 'f'); % add projection file
delete(wb)

if isequal(prj_luf.Name, "World_Cylindrical_Equal_Area") % change projection file from 4326 to 54034
    output_prj = "Footprints_"+extractBefore(bld_lyr_name,".")+".prj";
