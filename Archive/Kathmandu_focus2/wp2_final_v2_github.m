...
%% Input File Folder 
input_file_folder = 'C:\Kandilli Projects\tomorrow_cities\RandomAssignments\Codes\Kathmandu\Kathmandu_focus2\';

% Read Landuse File
TV0_data_landuse = readtable( [ input_file_folder 'Landuse_Kathmandu_Focus_2.dbf'], "FileType","spreadsheet");
...
TV0_data_landuse.avgIncome{1} ='lowIncomeB';
TV0_data_landuse.avgIncome{2} ='lowIncomeB';
TV0_data_landuse.avgIncome{4} ='highIncome';
TV0_data_landuse.avgIncome{6} ='highIncome';
TV0_data_landuse.avgIncome{8} ='highIncome';
TV0_data_landuse.avgIncome{9} ='highIncome';
TV0_data_landuse.avgIncome{11} ='lowIncomeB';
TV0_data_landuse.avgIncome{13} ='midIncome';
TV0_data_landuse.avgIncome{14} = 'lowIncomeA';
