...
allowed_income_types = {'lowIncomeA','lowIncomeB','midIncome','highIncome'};
% fix upper case of avg income
for z = 1 : size(TV0_data_landuse,1)
    if any(strcmpi(allowed_income_types, TV0_data_landuse.avgIncome{z}))
        TV0_data_landuse.avgIncome{z}(1) = lower(TV0_data_landuse.avgIncome{z}(1));
    end
end


avg_income_types = unique(TV0_data_landuse.avgIncome);
for k = 1 : numel(allowed_income_types)
    if ~any(strcmp(allowed_income_types, avg_income_types{k}))
        avg_income_types(k) = [];
    end
end

% make it a row (just in case)
...
warning('FIX ME')
nPeople = TV0_data_landuse.population;
nPeople(isnan(nPeople)) = 0;
...
for i = 1: length(avg_income_types)
    ...
    income_of_households = dist_avgIncome.(avg_income_types{i})*sum(income_idx);
    % Find the cumulative sum  
...
gender_of_individuals=dist_avgIncome*n_total_people;
% Find the cumulative sum  
...
dist_table7 = {[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0];...    % LUT1
               [0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0];...    % LUT2
               [0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0];...    % LUT3
               [0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0];...    % LUT4
               [0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0];...    % LUT5
               [0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0];...    % LUT6
               [0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0];...    % LUT7
               [0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0];...    % LUT8
               [0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0];...    % LUT9
               [0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0];...    % LUT10
               [0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0];...    % LUT11
               [0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0],[0.8 0.2 0.0]};      % LUT12
...
Com_Table = table9(1:length(land_use_types),3) .* double(table9(1:length(land_use_types),1)==0);
...
table9 = cell2mat(dist_table9);
Ind_Table = table9(1:length(land_use_types),2) .* double(table9(1:length(land_use_types),1)==0);
...
total_individuals = sum([TV0_data_building(:).residents].');
numb_school =  max(round(total_individuals/10000),1); % School specialFac=1
numb_hospital = max(round(total_individuals/25000),1); % Hospital specialFac=2
...
writetable(household_data,'Household_Layer.xlsx');
writetable(individual_data,'Individual_Layer.xlsx');
writetable(TV0_data_landuse,'Landuse_Layer.xlsx');
