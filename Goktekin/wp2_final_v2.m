...
%% Input File Folder 
input_file_folder = 'C:\Kandilli Projects\tomorrow_cities\RandomAssignments\';
...
% For All Zone-IDs
area = 15*ones(49,1); % Area should be known

nPeople = TV0_data_landuse.densityCap.*area - TV0_data_landuse.population;
...
% Add new population to Land use Layer
TV0_data_landuse.newPop = nPeople;
